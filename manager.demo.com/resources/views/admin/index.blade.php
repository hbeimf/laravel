...
<head>
    ...
    <link href="/style/css/style-metro.css" rel="stylesheet" type="text/css"/>

    <link href="/style/css/style.css" rel="stylesheet" type="text/css"/>

    <link href="/style/css/style-responsive.css" rel="stylesheet" type="text/css"/>

    <link href="/style/css/default.css" rel="stylesheet" type="text/css" id="style_color"/>

    <link href="/style/css/uniform.default.css" rel="stylesheet" type="text/css"/>

    <!-- END GLOBAL MANDATORY STYLES -->

    <!-- BEGIN PAGE LEVEL STYLES -->

    <link href="/style/css/jquery.gritter.css" rel="stylesheet" type="text/css"/>

    <link href="/style/css/daterangepicker.css" rel="stylesheet" type="text/css" />

    <link href="/style/css/fullcalendar.css" rel="stylesheet" type="text/css"/>

    <link href="/style/css/jqvmap.css" rel="stylesheet" type="text/css" media="screen"/>

    <link href="/style/css/jquery.easy-pie-chart.css" rel="stylesheet" type="text/css" media="screen"/>
                    ...
                    <ul class="dropdown-menu extended inbox">
                        ...
                        <li>
                            ...
                            <a href="inbox.html?a=view">
                                ...
                                <span class="photo"><img src="/style/image/avatar2.jpg" alt="" /></span>
                        ...
                        <li>
                            ...
                            <a href="inbox.html?a=view">
                                ...
                                <span class="photo"><img src=".//style/image/avatar3.jpg" alt="" /></span>
                        ...
                        <li>
                            ...
                            <a href="inbox.html?a=view">
                                ...
                                <span class="photo"><img src=".//style/image/avatar1.jpg" alt="" /></span>
                        ...
                        <div class="portlet solid bordered light-grey">
                            ...
                            <div class="portlet-body">
                                ...
                                <div id="site_statistics_loading">
                                    ...
                                    <img src="/style/image/loading.gif" alt="loading" />
                                            ...
                                            <div class="scroller" data-height="290px" data-always-visible="1" data-rail-visible1="1">
                                                ...
                                                <div class="row-fluid">
                                                    ...
                                                    <div class="span6 user-info">
                                                        ...
                                                        <img alt="" src="/style/image/avatar.png" />
                                ...
                                <div class="scroller" data-height="435px" data-always-visible="1" data-rail-visible1="1">
                                    ...
                                    <ul class="chats">
                                        ...
                                        <li class="in">
                                            ...
                                            <img class="avatar" alt="" src="/style/image/avatar1.jpg" />
                                        ...
                                        <li class="out">
                                            ...
                                            <img class="avatar" alt="" src="/style/image/avatar2.jpg" />
                                        ...
                                        <li class="out">
                                            ...
                                            <img class="avatar" alt="" src="/style/image/avatar3.jpg" />
...
<script src="/style/js/jquery-ui-1.10.1.custom.min.js" type="text/javascript"></script>
...
<script src="/style/js/jquery.slimscroll.min.js" type="text/javascript"></script>

<script src="/style/js/jquery.blockui.min.js" type="text/javascript"></script>

<script src="/style/js/jquery.cookie.min.js" type="text/javascript"></script>

<script src="/style/js/jquery.uniform.min.js" type="text/javascript" ></script>

<!-- END CORE PLUGINS -->

<!-- BEGIN PAGE LEVEL PLUGINS -->

<script src="/style/js/jquery.vmap.js" type="text/javascript"></script>

<script src="/style/js/jquery.vmap.russia.js" type="text/javascript"></script>

<script src="/style/js/jquery.vmap.world.js" type="text/javascript"></script>

<script src="/style/js/jquery.vmap.europe.js" type="text/javascript"></script>

<script src="/style/js/jquery.vmap.germany.js" type="text/javascript"></script>

<script src="/style/js/jquery.vmap.usa.js" type="text/javascript"></script>

<script src="/style/js/jquery.vmap.sampledata.js" type="text/javascript"></script>

<script src="/style/js/jquery.flot.js" type="text/javascript"></script>

<script src="/style/js/jquery.flot.resize.js" type="text/javascript"></script>

<script src="/style/js/jquery.pulsate.min.js" type="text/javascript"></script>

<script src="/style/js/date.js" type="text/javascript"></script>

<script src="/style/js/daterangepicker.js" type="text/javascript"></script>

<script src="/style/js/jquery.gritter.js" type="text/javascript"></script>

<script src="/style/js/fullcalendar.min.js" type="text/javascript"></script>

<script src="/style/js/jquery.easy-pie-chart.js" type="text/javascript"></script>

<script src="/style/js/jquery.sparkline.min.js" type="text/javascript"></script>
